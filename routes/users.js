...
router.get("/:username", ensureLoggedIn, authenticateJWT, ensureAdmin, async function (req, res, next) {
  try {
 ...
 * 
 * Allows a user to apply for a job. This route requires the username of the 
 * user applying for the job and the job's id as URL parameters.
 * 
 * Authorization required: Logged in (users can apply to jobs on their own behalf).
 */
